...
def test_create_booking(playwright:Playwright):
    ...
    assert booking["firstname"] == "Raisha"
    assert booking["lastname"] == "Begum"
    ...
    assert booking["bookingdates"]["checkin"] == "2026-04-20"
    assert booking["bookingdates"]["checkout"] == "2026-04-21"
